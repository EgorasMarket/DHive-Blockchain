...
func (m *Manager) GetNodeVersion(ctx context.Context) (string, error) {
	exec, err := m.CreateExec([]string{"dhived", "version"}, m.ContainerID())
	if err != nil {
...
func (m *Manager) getTimeoutCommit(ctx context.Context) (*big.Int, error) {
	exec, err := m.CreateExec([]string{"grep", `\s*timeout_commit =`, "/root/.dhived/config/config.toml"}, m.ContainerID())
	if err != nil {
