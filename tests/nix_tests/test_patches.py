    ...
    test_cases = [
        {
            ...
            "exp_err": "invalid decimal coin expression: -1000000000dfuel",
            "lockup": {
                "start_time": 1625204910,
                "periods": [
                    {
                        "length_seconds": 2419200,
                        "coins": "10000000000dfuel",
                    }
                ],
            },
            "vesting": {
...
def test_unvested_token_delegation(evmos_cluster):
                ...
                "periods": [
                    {
                        ...
                        "coins": "10000000000000000000dfuel",
                    }
                ],
            },
            lockup_file,
            ...
            json.dump(
                {
                    ...
                    "periods": [
                        ...
                        {
                            "length_seconds": 2419200,
                            "coins": "3000000000000000000dfuel",
                        },
                        {
                            "length_seconds": 2419200,
                            "coins": "4000000000000000000dfuel",
                        },
                    ],
                },
                vesting_file,
    ...
    del_amt = "7000000000000000000dfuel"
